...
const RESUME_SLIDER_LIST: TSResume.SliderItem[] = [
  {
    key: RESUME_SLIDER_MAPS.personal,
    name: '个人信息',
    require: true,
    summary: '更好介绍自己，机会会更多',
  },
  {
    key: RESUME_SLIDER_MAPS.education,
    name: '教育信息',
    require: false,
    summary: '介绍你的学校和专业信息',
  },
  ...
  {
    key: RESUME_SLIDER_MAPS.schoolExperience,
    name: '在校经历',
    require: false,
    summary: '展示在校任职成果和人际关系',
  },
  {
    key: RESUME_SLIDER_MAPS.projectExperience,
    name: '项目经验',
    require: false,
    summary: '展示研究过什么优秀项目和成果',
  },
  {
    key: RESUME_SLIDER_MAPS.workExperience,
    name: '工作经历',
    require: false,
    summary: '申请岗位的相关经验和能力',
  },
  {
    key: RESUME_SLIDER_MAPS.certificate,
    name: '获奖证书',
    require: false,
    summary: '得过什么奖项值得炫耀',
  },
  {
    key: RESUME_SLIDER_MAPS.evaluation,
    name: '个人评价',
    require: false,
  ...
  {
    key: RESUME_SLIDER_MAPS.test,
    name: '测试用例',
    require: true,
    summary: '测试用例，一键覆盖',
  },
];
export default RESUME_SLIDER_LIST;
